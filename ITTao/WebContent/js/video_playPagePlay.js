 ...
 */
$(document).ready(function(){
	$('<embed id="videopalyer" src="./player.swf" allowfullscreen="true" flashvars="controlbar=over&image=./photo.png&file=./Breathless.mp4" width="660" height="530"/>').appendTo("#playWindow");
    ...
    $.ajax({
        ...
        success : function(data) {
        	...
        	//找到了
        	if(t !=-1){
            $('<embed id="videopalyer" src="./player.swf" allowfullscreen="true" flashvars='+data+' width="660" height="530"/>').appendTo("#playWindow");
        	}else{
        	//alert("ascas");
